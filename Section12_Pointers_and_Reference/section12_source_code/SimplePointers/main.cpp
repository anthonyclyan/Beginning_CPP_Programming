...
// ========== Pointer ==========
    ...
    cout << "Value of p is: " << p << endl;             // Output: garbage since p is not initialized
...
// ========== 5 Pointers ==========
    ...
    cout << "sizeof p1 is: " << sizeof p1 << endl;        // Output: 4 bytes, in my case it is 8 bytes
    cout << "sizeof p2 is: " << sizeof p2 << endl;        // Output: 4 bytes, in my case it is 8 bytes
    cout << "sizeof p3 is: " << sizeof p3 << endl;        // Output: 4 bytes, in my case it is 8 bytes
    cout << "sizeof p4 is: " << sizeof p4 << endl;        // Output: 4 bytes, in my case it is 8 bytes
    cout << "sizeof p5 is: " << sizeof p5 << endl;        // Output: 4 bytes, in my case it is 8 bytes
